...
/**
 * Exception thrown when attempting to look up a reserved ASN.
 */
class ReservedAsnException extends IpregistryException
{
    /**
    ...
    public function __construct(
        ...
        $message = "The provided ASN is reserved and cannot be looked up: " . $message;
