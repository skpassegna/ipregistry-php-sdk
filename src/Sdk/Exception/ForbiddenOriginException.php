...
/**
 * Exception thrown when the request is forbidden due to origin filtering.
 */
class ForbiddenOriginException extends IpregistryException
{
    /**
    ...
    public function __construct(
        ...
        $message = "The request was forbidden because your origin is not allowed: " . $message;
