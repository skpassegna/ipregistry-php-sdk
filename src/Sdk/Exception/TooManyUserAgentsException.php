...
/**
 * Exception thrown when too many User-Agents are provided in a batch request.
 */
class TooManyUserAgentsException extends IpregistryException
{
    /**
    ...
    public function __construct(
        ...
        $message = "Too many User-Agents were provided in the batch request: " . $message;
